...
public class HealtConditionBusinessServiceImpl implements IHealtConditionBusinessService {
     ...
     * (non-Javadoc)
     * 
     * @see org.healtcare.hypermediadriven.patient.business.services.IHealtConditionBusinessService#readHealtConditionByPatient(java.lang.String)
     */
    @Override
    public HealtConditionDTO readHealtConditionByPatient(final String patientUUID) throws HypermediaGenericException {
        LOGGER.info("####### - Started HealtConditionBusinessServiceImpl.readHealtConditionByPatient(String patientUUID) - #######");
        ...
        LOGGER.info("####### - Stopped HealtConditionBusinessServiceImpl.readHealtConditionByPatient(String patientUUID) - #######");
        return dto;
    }
