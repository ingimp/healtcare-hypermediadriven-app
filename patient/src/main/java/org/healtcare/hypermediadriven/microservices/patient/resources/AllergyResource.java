...
public class AllergyResource extends ResourceWithEmbeddeds {
	...
	@JsonCreator
	public AllergyResource(@JsonProperty("allergyUUID") String allergyUUID,
			@JsonProperty("allergyName") String allergyName,
			@JsonProperty("allergyDescription") String allergyDescription) {
		super();
