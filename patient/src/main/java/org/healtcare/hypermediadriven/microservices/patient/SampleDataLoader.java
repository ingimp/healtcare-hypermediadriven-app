...
public class SampleDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		// final Patient[] patients = { patientRepository.save(new
		// Patient(UUID.randomUUID().toString(), "Rick", "Deckard", "M")),
		// patientRepository.save(new Patient(UUID.randomUUID().toString(),
		// "Roy", "Batty", "M")),
		// patientRepository.save(new Patient(UUID.randomUUID().toString(),
		// "Denise", "Fox", "F")), patientRepository.save(new
		// Patient(UUID.randomUUID().toString(), "Carol", "Smith", "F")) };
		//
